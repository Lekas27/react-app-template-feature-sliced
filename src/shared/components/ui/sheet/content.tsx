...
export const SheetContent: FC<Props> = ({
  className,
  children,
  side = "right",
  ...props
  ...
  <SheetPortal>
    ...
    <Content
      ...
      className={mergeClasses(
        "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 bg-gray-50 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-gray-900",
        side === "right" &&
